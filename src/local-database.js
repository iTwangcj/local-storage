...
import type { StorageList, LocalStorage, Logger, Config, Callback } from '@fem/types';
import type { IPackageStorage, ILocalData } from '@fem/local-storage';
...
class LocalDatabase implements ILocalData {
    ...
    _sync () {
        if (this.locked) {
            ...
            return new Error('fem database is locked, please contact your administrator to checkout logs during fem startup.');
        }
